...
var app;
(function (app) {
    var JokerMainDelegate = (function () {
        function JokerMainDelegate() {
        ...
        * 初始化有猫腻Sdk
        */
        JokerMainDelegate.prototype.initYouMaoNiSdk = function () {
            //初始化有猫腻sdk
         ...
         * 设置常量定义
         */
        JokerMainDelegate.prototype.setAppConst = function () {
            ...
            AppConst.OUT_SVR = new cy.SrsIp(0, "61.164.152.71", 5601, 502, 3790, "123.59.14.4:9091", "123.59.14.4:9092", "外网71", 1 /* PUBLIC */);
            AppConst.IN_SVR2 = new cy.SrsIp(0, "192.168.135.57", 4102, 502, 4001, "192.168.138.131:9091", "192.168.138.131:9092", "内网57", 3 /* MINE_57 */);
        };
        /**
         * 设置srs连接的ip
         */
        JokerMainDelegate.prototype.setSrsConfig = function () {
         ...
         * 设置房间
         */
        JokerMainDelegate.prototype.setRoomConfig = function () {
            //内网房间配置 57 
         ...
         * 应用启动
         */
        JokerMainDelegate.prototype.appLanuch = function () {
            this.setAppConst();
            this.setSrsConfig();
            this.setRoomConfig();
        ...
        JokerMainDelegate.prototype.onStageChange = function (event) {
         ...
         */
        JokerMainDelegate.prototype.onConfigComplete = function (event) {
        ...
        JokerMainDelegate.prototype.gameCfgEvent = function (evt) {
        };
        JokerMainDelegate.prototype.gameErrorEvent = function (evt) {
            gameabc.ResourceBundleUtil.setErrorSourceData(evt);
        };
        JokerMainDelegate.prototype.gameMsgEvent = function (evt) {
         ...
         */
        JokerMainDelegate.prototype.onThemeLoadComplete = function () {
         ...
         */
        JokerMainDelegate.prototype.onResourceLoadComplete = function (event) {
        ...
        JokerMainDelegate.prototype.createScene = function () {
        ...
        //最小化时处理
        JokerMainDelegate.prototype.deactivateHandler = function (event) {
        ...
        //激活时处理
        JokerMainDelegate.prototype.activeHandler = function (event) {
            // console.log("active");
         ...
         */
        JokerMainDelegate.prototype.onItemLoadError = function (event) {
         ...
         */
        JokerMainDelegate.prototype.onResourceLoadError = function (event) {
            //TODO
         ...
         */
        JokerMainDelegate.prototype.onResourceProgress = function (event) {
         ...
         */
        JokerMainDelegate.prototype.startCreateScene = function () {
        ...
        JokerMainDelegate.prototype.onCallback = function (code, msg) {
        ...
        return JokerMainDelegate;
    }());
    app.JokerMainDelegate = JokerMainDelegate;
    __reflect(JokerMainDelegate.prototype, "app.JokerMainDelegate", ["app.IAppDelegate"]);
})(app || (app = {}));
//# sourceMappingURL=JokerMainDelegate.js.map