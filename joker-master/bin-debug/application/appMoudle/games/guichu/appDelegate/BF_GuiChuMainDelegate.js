...
var app;
(function (app) {
    var BF_GuiChuMainDelegate = (function () {
        function BF_GuiChuMainDelegate() {
            this.isThemeLoadEnd = false;
            this.isResourceLoadEnd = false;
            console.log("欢迎进入边锋转盘");
        }
        /**
        * 初始化有猫腻Sdk
        */
        BF_GuiChuMainDelegate.prototype.initYouMaoNiSdk = function () {
            //初始化有猫腻sdk
            PlatformSdk.setListener(this.onCallback, this);
            PlatformSdk.init();
        };
        BF_GuiChuMainDelegate.prototype.setAppConst = function () {
        };
        BF_GuiChuMainDelegate.prototype.setSrsConfig = function () {
            /**
             * 覆盖外网正式服srs地址
             */
            cy.getSrsIp = function () {
                if (cy.srsList == null) {
                    cy.srsList = [
                        new cy.SrsIp(4925, "118.178.143.93", 4004, 1560, 0, "123.59.14.4:9091", "123.59.14.4:9092", "正式环境", 2 /* AUTO_SRS */, 10),
                        new cy.SrsIp(4926, "118.178.143.93", 4005, 1560, 0, "123.59.14.4:9091", "123.59.14.4:9092", "正式环境", 2 /* AUTO_SRS */, 10),
                        new cy.SrsIp(4927, "118.178.143.93", 4006, 1560, 0, "123.59.14.4:9091", "123.59.14.4:9092", "正式环境", 2 /* AUTO_SRS */, 10)
                    ];
                }
            ...
            cy.getChrooseSrsList = function () {
                var ipList = [cy.getSrsIp()];
                return ipList;
            };
        };
        BF_GuiChuMainDelegate.prototype.setRoomConfig = function () {
            //设置外网正式服房间
            if (true) {
                room.getProxy().zRoom1 = [
                    room.getProxy().createNormalRoom(101, 10, 20, 500, 2000, 4909, 705604, 6, false, 0, [1, 1, 1, 1, 1])
                ];
            }
            else {
                room.getProxy().zRoom1 = [
                    room.getProxy().createNormalRoom(101, 10, 20, 500, 2000, 4908, 705603, 6, false, 0, [1, 1, 1, 1, 1]),
                ];
            }
        };
        /**
         * 应用启动
         */
        BF_GuiChuMainDelegate.prototype.appLanuch = function () {
            this.setAppConst();
            this.setSrsConfig();
            this.setRoomConfig();
        ...
        BF_GuiChuMainDelegate.prototype.onStageChange = function (event) {
         ...
         */
        BF_GuiChuMainDelegate.prototype.onConfigComplete = function (event) {
        ...
        BF_GuiChuMainDelegate.prototype.gameCfgEvent = function (evt) {
        };
        BF_GuiChuMainDelegate.prototype.gameErrorEvent = function (evt) {
            gameabc.ResourceBundleUtil.setErrorSourceData(evt);
        };
        BF_GuiChuMainDelegate.prototype.gameMsgEvent = function (evt) {
         ...
         */
        BF_GuiChuMainDelegate.prototype.onThemeLoadComplete = function () {
         ...
         */
        BF_GuiChuMainDelegate.prototype.onResourceLoadComplete = function (event) {
        ...
        BF_GuiChuMainDelegate.prototype.createScene = function () {
        ...
        //最小化时处理
        BF_GuiChuMainDelegate.prototype.deactivateHandler = function (event) {
        ...
        //激活时处理
        BF_GuiChuMainDelegate.prototype.activeHandler = function (event) {
            // console.log("active");
         ...
         */
        BF_GuiChuMainDelegate.prototype.onItemLoadError = function (event) {
         ...
         */
        BF_GuiChuMainDelegate.prototype.onResourceLoadError = function (event) {
            //TODO
         ...
         */
        BF_GuiChuMainDelegate.prototype.onResourceProgress = function (event) {
         ...
         */
        BF_GuiChuMainDelegate.prototype.startCreateScene = function () {
        ...
        BF_GuiChuMainDelegate.prototype.onCallback = function (code, msg) {
        ...
        return BF_GuiChuMainDelegate;
    }());
    app.BF_GuiChuMainDelegate = BF_GuiChuMainDelegate;
    __reflect(BF_GuiChuMainDelegate.prototype, "app.BF_GuiChuMainDelegate", ["app.IAppDelegate"]);
})(app || (app = {}));
//# sourceMappingURL=BF_GuiChuMainDelegate.js.map