...
(function (uicomps) {
     ...
     * @callObj 执行回函数时的原型对象
     */
    function confirmNeedSilver(isFoce, needSilver, maxSilver, defaultMin, showClose, showBank, callBackFunc, callObj) {
        if (isFoce === void 0) { isFoce = false; }
        if (defaultMin === void 0) { defaultMin = true; }
        if (showClose === void 0) { showClose = false; }
        if (showBank === void 0) { showBank = false; }
    ...
    uicomps.confirmNeedSilver = confirmNeedSilver;
    var DragInComp = (function () {
        function DragInComp() {
        }
        DragInComp.getInstance = function () {
         ...
         */
        DragInComp.prototype.confirmNeedSilver = function (isforce, needSilver, maxSilver, defaultMin, showClose, showBank, confirmCallBack, thisObj) {
            if (isforce === void 0) { isforce = false; }
            if (defaultMin === void 0) { defaultMin = true; }
            if (showClose === void 0) { showClose = false; }
            if (showBank === void 0) { showBank = true; }
            if (thisObj === void 0) { thisObj = null; }
            var self_silver = user.getProxy().svrGameData.silver;
    ...
    uicomps.DragInComp = DragInComp;
    __reflect(DragInComp.prototype, "uicomps.DragInComp");
})(uicomps || (uicomps = {}));
//# sourceMappingURL=DragInUIComp.js.map