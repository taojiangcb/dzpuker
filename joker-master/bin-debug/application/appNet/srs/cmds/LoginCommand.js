...
(function (cy) {
    ...
    var LoginCommand = (function (_super) {
        ...
        LoginCommand.prototype.sendHandler = function (data, stream) {
            switch (this.action) {
        ...
        LoginCommand.prototype.resultHandler = function (stream) {
            switch (this.action) {
                case app.NetAction.RE_GET_SRS_LOAD:
                    ...
                    if (reFlag && cy.searchNiceServer() != srs) {
                        mc2sdk.event(50012 /* SRS_RECONNECT */);
                ...
                case app.NetAction.CMDT_PLAYERDATA:
                    ...
                    if (cbFlag != 0)
                        mc2sdk.event(54002 /* LOGIN_FAIELD */, cbFlag);
                    if (cbFlag == 1) {
                        ...
                        var sdoid = user.getProxy().loginName;
                        var AD = "0";
                        var registerURL = AppConst.BFPT_TO_GAMET_REG_URL;
                        sdoid = "sdoid=" + sdoid;
                        AD = "AD=" + AD;
                ...
                case app.NetAction.CMDT_RESPPLAYERPLUSDATA:
                    ...
                    var playerPlusData = user.getProxy().reqPlayerPlusData;
    ...
    cy.LoginCommand = LoginCommand;
    __reflect(LoginCommand.prototype, "cy.LoginCommand");
})(cy || (cy = {}));
