...
(function (gameabc) {
    var md5 = (function () {
        ...
        md5.hex_hmac_md5 = function (k, d) { return this.rstr2hex(this.rstr_hmac_md5(this.str2rstr_utf8(k), this.str2rstr_utf8(d))); };
        md5.b64_hmac_md5 = function (k, d) { return this.rstr2b64(this.rstr_hmac_md5(this.str2rstr_utf8(k), this.str2rstr_utf8(d))); };
        md5.any_hmac_md5 = function (k, d, e) { return this.rstr2any(this.rstr_hmac_md5(this.str2rstr_utf8(k), this.str2rstr_utf8(d)), e); };
        /*
         ...
         */
        md5.rstr2hex = function (input, hexcase) {
         ...
         */
        md5.rstr2b64 = function (input, b64pad) {
         ...
         * usage:
             ...
             var timeStr: string = gameabc.md5.hash("time+""");
    ...
    gameabc.md5 = md5;
    __reflect(md5.prototype, "gameabc.md5");
})(gameabc || (gameabc = {}));
