module gameabc {
    export class HeadAttackMove extends egret.EventDispatcher implements IMove {

        private _linespeed: number = NaN;
        public alltime: number = 60;
        ...
        public constructor(linespeed: number = 900,t: number = 60,g: number = 0.3) {
            super();
        ...
        public go(fromX: number,fromY: number,toX: number = 0,toY: number = 0,recallfun: Function = null) {
            ...
            this._toX = toX;
            this._toY = toY;
            this._iMove = new ParabolaMove(this.alltime,this._g);
