...
module playcards {
     ...
     * 摇钱树
     */
    export class PlayCardsGodTreeUIModuleComp extends app.base.BaseWndUIMoudleComponent {

        public txtCount:eui.BitmapLabel;
        public btnAward:eui.Group;
        public dayLabelGroup:eui.Group;
        public txtTime:eui.Label;
        public chouMa:eui.Group;
        public txtChouma:eui.BitmapLabel;
        public txtItemname:eui.Label;
        public greenLabeGroup:eui.Group;
        public greenAward:eui.BitmapLabel;
        public allAward:eui.Label;
        ...
        constructor() {
            super()
            this.skinName = "resource/app_skin/playcards/PlayGodTree.exml";
        }
        ...
        invalidateFullData():void {
            ...
            this.intervalId = egret.setTimeout(()=>{
                this.fullData();
            },this,50);
        ...
        setAwardBtnEnabled(val:boolean) {
            if(val) {
        ...
        updateData(dt:number):void {
            ...
            if(this.missionTemplate.itemId.length > 0) {
                var itemName:string = "," + this.missionTemplate.descript + "*1";
        ...
        touchBindButtonHandler(tag:egret.DisplayObject):void {
            switch(tag) {
                ...
                case this.btnAward:
                    ...
                    /**摇钱树埋点*/
                    mc2sdk.event(mc2sdk.EVENT_TYPE.MISSION_GOLD_TREE);
                    break;
