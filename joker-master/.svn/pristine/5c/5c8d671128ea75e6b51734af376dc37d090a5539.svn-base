module cy {
	 ...
	 */
    export class ToolCommand extends SrsCommand {
        ...
        resultHandler(stream: SrsStreamReader): void {
            ...
            switch(this.action) {
                ...
                case app.NetAction.RE_TOOL_RILVER:
                    ...
                    if (flag == 0) {
                        var data = <cyvos.PlayerGameData>stream.getSuruct(cyvos.PlayerGameData);
                        ...
                        mc2sdk.event(mc2sdk.EVENT_TYPE.RILVER_FAILED,flag);
                        cy.log("获取自己的游戏数据失败 flag="+flag,cy.LOG_TYPE.UNDEFINE);
                    }
                    return;
                ...
                case app.NetAction.RE_TOOL_NUMPLAYERS:
                    ...
                    if (flag==0) {
                        ...
                        cy.log("获取房间人数失败",cy.LOG_TYPE.UNDEFINE);
                ...
                case app.NetAction.RE_TOOL_TEMP_SESSION:
                    ...
                    if (flag==0) {
                         ...
                         */
                        utils.TempSessionUtils.receiver_call.forEach(element => {
                            element();
                        });
                ...
                case app.NetAction.RESP_PLAYERPLACE:
                    ...
                    for (var i=0; i<count; ++i) {
                        ...
                        user.getProxy().places[i] = <cyvos.PlayerPlace>place;
                    }
                    return;
