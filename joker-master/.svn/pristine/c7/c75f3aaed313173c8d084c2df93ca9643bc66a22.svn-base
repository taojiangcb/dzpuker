...
module gameabc {
    export class md5 {
         ...
         */
        public static hex_md5(s) { return this.rstr2hex(this.rstr_md5(this.str2rstr_utf8(s))); }
        public static b64_md5(s) { return this.rstr2b64(this.rstr_md5(this.str2rstr_utf8(s))); }
        public static any_md5(s,e) { return this.rstr2any(this.rstr_md5(this.str2rstr_utf8(s)),e); }
         ...
         */
        public static rstr2hex(input,hexcase = 0) {
         ...
         */
        public static rstr2b64(input,b64pad="") {
