...
module app {
    ...
    export class BF_GuiChuMainDelegate implements IAppDelegate {
        ...
        */
        ...
        setSrsConfig():void {
            ...
            cy.getSrsIp = function():cy.SrsIp {
				if(cy.srsList == null) {
					cy.srsList = [
						new cy.SrsIp(4925, "118.178.143.93",  4004,   1560,    0,  "123.59.14.4:9091",  "123.59.14.4:9092","正式环境",room.CONFIG.AUTO_SRS,10),
                        new cy.SrsIp(4926, "118.178.143.93",  4005,   1560,    0,  "123.59.14.4:9091",  "123.59.14.4:9092","正式环境",room.CONFIG.AUTO_SRS,10),
						new cy.SrsIp(4927, "118.178.143.93",  4006,   1560,    0,  "123.59.14.4:9091",  "123.59.14.4:9092","正式环境",room.CONFIG.AUTO_SRS,10)
					];
        		}
            ...
            cy.getChrooseSrsList = function():cy.SrsIp[] {
                var ipList:cy.SrsIp[] = [cy.getSrsIp()];
                return ipList;
            }
        }
